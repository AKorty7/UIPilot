...
The seven `Theme_*.png` images are 960 x 540 renders of the main menu in each preset
theme (the genre ones over their scenes from `tools/store/genre_backdrops.py`; Pixel Retro
